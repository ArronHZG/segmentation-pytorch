...
def split_valid_image(image_path, image_name, save_path, mode, output_image_h_w=(256, 256)):
    '''
    读入图片为 H,W,C
    :param image_path:
    :param image_name:
...
def test_spilt_valid_image():
    ...
    for label_name in tqdm( name_list ):
        ...
        # print(image_name)
        # print(label_name)
        split_valid_image( image_label_path, label_name, save_label_path, mode="RGB" )
        split_valid_image( image_path, image_name, save_image_path, mode="CMYK" )
