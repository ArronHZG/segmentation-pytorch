...
class UNet(nn.Module):
    ...
    def __init__(self, num_classes, in_channels, feature_scale=2, is_deconv=True, is_batchnorm=True):
...
class UNet_Nested(nn.Module):
    ...
    def __init__(self, num_classes, in_channels, feature_scale=2, is_deconv=True, is_batchnorm=True, is_ds=True):
