...
from foundation.blseg.backbone.utils import conv3x3
from foundation.blseg.model.base import SegBaseModule
from .ppm import PPM
...
class PSPNet(SegBaseModule):
    ...
    def __init__(self,
        ...
        self.backbone = self._get_backbone(in_c, backbone)
