...
def getBackBone(name, in_channels=3, output_stride=16, pretrained=True):
    model_map = {
        'resnet50': DeepLabV3PlusResNet50,
        'resnet101': DeepLabV3PlusResNet101,
...
def DeepLabV3PlusResNet50(in_channels=3, output_stride=16, pretrained=True):
    return ResNet(backbone="resnet50", in_channels=in_channels, output_stride=output_stride,
